...
| **10:45–11:15** | **S2: Introduction to AI Models**           | Linear models, neural networks, CNNs and AI agent types (Reflex, Model-Based, Goal-Based, Utility-Based, Learning Agents) in space missions. | **Introduction to AI & Data Science**     |
...
| **3:45–4:00**   | **S8: Team Brainstorming & Role Assignment** | Teams begin brainstorming their approach to the mission and plan tasks [Slides(https://github.com/RudyMartin/dsai-2025/blob/main/outline/5-Presentation-Slides/12_Engineering_Design_Concepts_for_Students.pptx)| **Team Collaboration and Project Work**   |
